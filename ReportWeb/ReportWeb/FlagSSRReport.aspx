<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="FlagSRRReport.aspx.vb" Inherits="ReportWeb.FlagSRRReport" title="LAPORAN PENGEMBALIAN ATAS PERMINTAAN PENGIRIM" %>
		...
		<TBODY>
			<TR>
				<TD align=center colSpan=3>
					<asp:Label id="lblJudul" runat="server" CssClass="Judul" Text="LAPORAN PENGEMBALIAN ATAS PERMINTAAN PENGIRIM" Font-Bold="True"></asp:Label>
				</TD>
			</TR>
			<TR>
				<TD colSpan=3></TD>
