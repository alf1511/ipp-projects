...
Partial Class LaporanRekapBASelisih
    ...
    Private Sub Proses(ByVal TanggalAwal As String, ByVal TanggalAkhir As String, ByVal KodeEkspedisi As String, ByVal NamaEkspedisi As String, ByVal ExpenseType As String, ByVal ExpenseTypeDesc As String, ByVal NoAwb As String, ByVal PreviewOnly As Boolean)
        ...
        If User <> "" Then
            ...
            Try
                ...
                SqlQuery = "call `report_Rekap_Ba_Selisih`(@TanggalAwal, @TanggalAkhir, @KodeEkspedisi, @Proses, @NoAwb, @PreviewOnly);"
                ...
                If PreviewOnly Then
                    ...
                    Session("TitleReport") = "LAPORAN REKAP BA SELISIH"
                ...
                Else
                    ...
                    Dim FileName As String = "ReportRekapBASelisih_" & AutoNum
