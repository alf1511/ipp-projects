...
Partial Class FlagHRBReport
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            'Else
            '    ErrorList.AppendLine("ERROR GetRegionList!")
            'End If
    ...
    Private Sub ProsesPreview(ByVal PreviewOnly As Boolean)
        ...
        Try
            If ValidasiProses(NoAWB) Then
                ...
                Proses(KodeEcommerce, NamaEcommerce, TipeSeller, TipeSellerName, SubCategorySeller, SubCategorySellerName, KodeLayanan, NamaLayanan, TanggalAwal, TanggalAkhir, NoAWB, PreviewOnly)
    ...
    Private Sub Proses(ByVal KodeEcommerce As String, ByVal NamaEcommerce As String, ByVal TipeSeller As String, ByVal TipeSellerName As String, ByVal SubCategorySeller As String, ByVal SubCategorySellerName As String, ByVal KodeLayanan As String, ByVal NamaLayanan As String, ByVal TanggalAwal As String, ByVal TanggalAkhir As String, ByVal NoAWB As String, ByVal PreviewOnly As Boolean)
        ...
        If User <> "" Then
            ...
            Try
                ...
                SqlQuery = "call `report_historyoocflr`(@TanggalAwal,@TanggalAkhir,@KodeEcommerce,@TipeSeller,@SubCategorySeller,@KodeLayanan,@NoAWB,@PreviewOnly);"
                ...
                If PreviewOnly Then
                    ...
                    Session("TitleReport") = "LAPORAN FLAG GAGAL / HRB"
                ...
                Else
                    ...
                    Dim FileName As String = "FLAGHRB_" & AutoNum
