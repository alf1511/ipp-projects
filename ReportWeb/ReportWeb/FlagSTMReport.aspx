<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="FlagSTMReport.aspx.vb" Inherits="ReportWeb.FlagSTMReport" title="LAPORAN PERMINTAAN TERMINAL AWB" %>
		...
		<TBODY>
			<TR>
				<TD align=center colSpan=3>
					<asp:Label id="lblJudul" runat="server" CssClass="Judul" Text="LAPORAN PERMINTAAN TERMINAL AWB" Font-Bold="True"></asp:Label>
				</TD>
			</TR>
			<TR>
				<TD colSpan=3></TD>
